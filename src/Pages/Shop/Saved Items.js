            ...
            : 
              ...
              : 
                (
                  ...
                  savedItems.map((item) => 
                  (
                    <div key={item.id} className="border p-4 rounded shadow max-w-xs">
                      ...
                      <div className="flex flex-row justify-between mt-2 gap-4">
                        <button onClick={() => handleBuyNow(item)} className="px-3 py-2 bg-yellow-500 text-white rounded hover:bg-yellow-600">Buy Now</button>
                        <button onClick={() => handleRemoveClick(item)} className="px-3 py-2 bg-red-500 text-white rounded hover:bg-red-600">Remove from wishlist</button>
                      </div>
                    </div>
                  ))
                )
        ...
        (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-6 rounded shadow-md max-w-sm w-full">
              ...
              <p>Are you sure you want to remove <strong>{itemToRemove?.name}</strong> from your wishlist?</p>
